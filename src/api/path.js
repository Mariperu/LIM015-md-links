...
//Terminal: node ./src/api/path.js ./test/directory/file1.md

//Ejecutando módulo FileSystem, para interactuar con el sist. de archivos
const fs = require('fs');
...
//[0]y[1] se ignoran, son nativos de node.js. [2, 3, 4, ...]: contienen argumentos.
//ejm: ["node","file.js","<argument>",...]  =  node api ruta
